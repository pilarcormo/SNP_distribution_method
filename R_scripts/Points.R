...
ratio_positions0_1 <- read.csv("~/SNP_distribution_method/arabidopsis_datasets/sup1_chr4_10kb/ratio_positions0_1.csv")

ratio_positions_divlen_0_1 <- read.csv("~/SNP_distribution_method/arabidopsis_datasets/sup1_chr4_10kb/ratio_positions_divlen_0_1.csv")
...
ratiolen <-  ggplot(ratio_positions_divlen_0_1, aes(Position, Ratio)) + geom_point(colour="darkblue", shape=21, size = 4) + xlab(" ") + ylab("Ratio") + xlim(5000000, 15000000) + theme_bw() + ggtitle("Ratio/length")
