...
hom_snps, het_snps = ReformRatio.perm_pos(frags_ordered, snp_data)
...
####[5] MODEL GENOMES ######################
causal, candidate, percent = Mutation.test_genomes_define(hm_sh, ht_sh, hom_snps, het_snps, center, ratios, expected_ratios)
...
distribution_plots = Mutation.test_genomes_distribution_plot(center, ratios, expected_ratios, dataset, output_folder)