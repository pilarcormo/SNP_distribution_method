...
when 'background_vcf'
    ...
    pp chr_vcf, vcfs_chrom_p, vcfs_pos_p, vcfs_info_p
...
when 'filter_vcf' 
    ...
    int = "#{location}/interesting_#{chromosome}"
    Dir.mkdir(int)
    ...
    puts "A method for managing the vcf file needs to be provided. Use either 'background_vcf' or 'filter_vcf'"
end 
